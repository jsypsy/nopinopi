# Session Handoff
_Last updated: 2026-09-04 (B4 배포 · GRAC 제출물 · 콘솔 앱정보 1·2단계)_
...
콘솔       miniAppId **72506**, appName `nopinopi`, workspace 72091. **B4 테스트 배포 `01a0698c…`(2026-09-04 08:13, 문자 전송)**.
...
3. **콘솔 메타**: 1·2단계는 끝났다. GRAC 결정 뒤 3단계(등급분류번호·분류일·제작업자 신고번호·이용등급·내용정보·
   **대표자 인감/사인 이미지**·게임 주요화면 2쌍) → 확약 5개 → [검토 요청하기].
   핵심 지표(전환: 리워드 광고 시청 완료·몰입 플레이)는 아직 안 넣었다
...
- 콘솔 이미지는 **규격 해상도로 직접 렌더**한다(세로는 iframe 318×524 × dpr 2). 1px만 달라도 콘솔이 거부한다.
  콘솔 **부제 칸은 쉼표를 거부**한다 — 화면 문구에서 쉼표만 뺀 「오늘의 탑 몇 층까지?」로 넣었다
