...
const OUT = resolve(process.argv[2] ?? 'assets/shots')
const PORT = 5199
const CDP = 9333
const CHROME = [
...
const SCENES = [
  ...
  { file: '03-딱', js: '__shot.build(3, [0, 0, 0])', wait: 150 },
  { file: '04-높은탑', js: '__shot.build(45, Array.from({length:45}, (_, i) => (i % 4 === 3 ? 9 : 0)))', wait: 1500 },
  { file: '05-우주', js: '__shot.build(60)', wait: 1800 },
  { file: '06-게임오버', js: '__shot.miss()', wait: 2400 },
]
